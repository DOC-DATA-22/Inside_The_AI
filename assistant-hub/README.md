...
|-------|----------|----------|
| 🔎 AI news research | [Series 1](../series-1-research-assistant/) | your n8n research agent (webhook) |
...
(you get this URL in [Series 1, Week 4](../series-1-research-assistant/week-4-connect/)), then:
